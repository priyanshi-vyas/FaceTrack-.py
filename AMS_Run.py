    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='PriyanshiVyas', user='root', password='PHW#84#jeor', db='face_records')
        ...
        if subb == '':
            ...
            MFW.configure(background='#6A0DAD')
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/priya/FACE recognition PROJECT/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
                ...
                root.configure(background='#6A0DAD')
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/priya/FACE recognition PROJECT/Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                cs = 'C:/Users/priya/FACE recognition PROJECT/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'' + fileName'
    ...
    def log_in():
        ...
        if username == 'Priyanshi':
            if password == '1':
                ...
                cs = 'C:/Users/priya/FACE recognition PROJECT/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
